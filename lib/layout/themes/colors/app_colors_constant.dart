...
class AppColorsConstant {
  ...
  static const Color secondary = Color(0xFFEDE8FF);
  static const Color scaffoldBackground = Color(0xFFFAFAFF);
  ...
  static const Color orangeSecondary = Color(0xFFFFE9E1);
}
